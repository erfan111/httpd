...
shared_build =
AP_LIBS = /home/scc/cfs/benchmark/httpd/srclib/pcre/libpcre.la /home/scc/cfs/benchmark/httpd/srclib/apr-util/libaprutil-1.la -lexpat /home/scc/cfs/benchmark/httpd/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /home/scc/cfs/benchmark/httpd
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/home/scc/cfs/benchmark/httpd/srclib/apr/include -I/home/scc/cfs/benchmark/httpd/srclib/apr-util/include -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /home/scc/cfs/benchmark/httpd/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
...
APR_INCLUDEDIR = /home/scc/cfs/benchmark/httpd/srclib/apr/include
APR_VERSION = 1.4.5
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /home/scc/cfs/benchmark/httpd/srclib/apr-util/include
APU_VERSION = 1.4.1
